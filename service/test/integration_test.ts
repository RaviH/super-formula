...
describe('integration tests against local sam but real db', () => {
    ...
    it('when we create a new user, then that user is returned', function (done) {
        this.timeout(15000);
        expect(graphqlTypeDefs).to.not.eq(null);
        request.post('/')
            .send({
    ...
    it('when we get user by id, then that user is returned', function (done) {
        this.timeout(15000);
        expect(graphqlTypeDefs).to.not.eq(null);
        request.post('/')
            .send({
    ...
    it('when there are users then get all users returns all the users', function (done) {
        this.timeout(15000);
        expect(graphqlTypeDefs).to.not.eq(null);
        request.post('/')
            .send({
    ...
    it('when we update an existing user, then that user is returned', function (done) {
        this.timeout(15000);
        expect(graphqlTypeDefs).to.not.eq(null);
        request.post('/')
            .send({
    ...
    it('when deleting a NON existing user, then that user is returned', function (done) {
        this.timeout(15000);
        expect(graphqlTypeDefs).to.not.eq(null);
    ...
    it('when deleting an existing user, then that user is returned', function (done) {
        this.timeout(15000);
        expect(graphqlTypeDefs).to.not.eq(null);
        request.post('/')
            .send({
